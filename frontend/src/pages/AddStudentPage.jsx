    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card p-6 space-y-5">
          ...
          {/* Standard */}
          <div>
            <label htmlFor="standard" className="block text-sm font-medium text-surface-700 mb-2">
              Standard *
            </label>
            <div className="relative">
              ...
              <select
                ...
                onChange={handleChange}
                className={clsx('input pl-12', errors.standard && 'border-red-500 focus:ring-red-500')}
              >
